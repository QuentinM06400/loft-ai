...
import { QuestionScreen, QuestionNav, ContinueButton, BigButtonChoice, BigNumberStepper, BigTextarea, AddressInput, C } from "../WizardUI";
...
export default function Step1Logement({ data = {}, onChange, onNext, onBack, onSkip }) {
  ...
  // Question indices:
  // 0: type, 1: address, 2: floor (apt only), 3: elevator (apt only), 4: description, 5: max guests, 6: beds
      ...
      {q === 4 && (
        <QuestionScreen title="Décrivez votre logement en quelques phrases" sub="Votre concierge utilisera cette description pour se présenter." visible={vis}>
          <BigTextarea
            ...
            placeholder="Ex : Appartement lumineux de 45m² au 3ème étage avec vue dégagée. Entièrement rénové, idéal pour un couple ou une petite famille. Quartier calme à 5 min à pied de la plage."
            rows={5}
          />
